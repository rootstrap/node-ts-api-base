import { JsonController, Param, Body, Get, Post, Put, Delete, Authorized, BodyParam, UnauthorizedError, BadRequestError, Res } from "routing-controllers";
...
export class AuthController {
  ...
  @Post("/signin")
  async signIn(@BodyParam("email") email: string, @BodyParam("password") password: string) {
    if (!email || !password) {
